...
forever(function () {
    ...
    if (Projectile3.x < 10) {
        Projectile3.setPosition(160, randint(20, 80))
    }
    if (projectile.x < 10) {
        projectile.setPosition(160, randint(20, 80))
    }
    if (Projectile2.x < 10) {
        Projectile2.setPosition(160, randint(20, 80))
    }
    if (Projectile4.x < 10) {
        Projectile4.setPosition(160, randint(20, 80))
    }
})
